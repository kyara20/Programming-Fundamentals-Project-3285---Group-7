 ...
 * @author Andres Ruiz
 */
public class Encrypt_Code extends javax.swing.JFrame {

    /**
     * Creates new form Encrypt_Code
     */
    public Encrypt_Code() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        finalTxt.setRows(5);
        jScrollPane3.setViewportView(finalTxt);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String key = encrypt.getText();
        char letters[] = key.toCharArray();
        for(int i = 0; i < letters.length; i++){
            letters[i] = (char)(letters[i]+(char)25);
        }
        String cryp = String.valueOf(letters);
        decrypt.setText(cryp);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String cryp = decrypt.getText();
        char letters2[] = cryp.toCharArray();
        for(int i = 0; i < letters2.length; i++){
            letters2[i] = (char)(letters2[i]-(char)25);
        }
        String crypt = String.valueOf(letters2);
        finalTxt.setText(crypt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Encrypt_Code.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Encrypt_Code().setVisible(true);
            }
        });
    }
